                ...
                <div className="d-flex gap-3 justify-content-center flex-wrap">
                  {user ? (
                    isAdmin ? (
                      ...
                      <>
                        <Link to="/productos" className="btn btn-lg px-5 py-3 rounded-3" style={{ background: 'var(--accent-main)', color: '#fff', border: 'none' }}><i className="bi bi-basket me-2"></i> Ver Productos</Link>
                        <Link to="/perfil" onClick={scrollToTop} className="btn btn-lg px-5 py-3 rounded-3" style={{ background: 'transparent', border: '1px solid var(--accent-main)', color: 'var(--accent-main)' }}><i className="bi bi-person me-2"></i> Mi Perfil</Link>
                      </>
                    )
                  ) : (
                    <>
