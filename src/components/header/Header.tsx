...
import styles from "./Header.module.css"; // reuse header styles as module
...
const Navbar: React.FC = () => {
    ...
    return (
        <header>
            <nav className={`navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top ${styles['primary-nav']}`}>
                <div className="container">
                    <Link to="/" className={`navbar-brand d-flex align-items-center`}>
                        <img src="/images/logos/logo_titulo.png" alt="Pastelería Mil Sabores" height={32} className={`me-2 ${styles['brand-logo']}`} />
                    </Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav ms-auto align-items-lg-center">
                            ...
                            <li className="nav-item">
                                <Link to="/contacto" onClick={handleNavClick} className="nav-link"><i className="bi bi-envelope me-1"></i>Contacto</Link>
                            </li>
                            ...
                            {user ? (
                                <>
                                    <li className="nav-item dropdown">
                                        ...
                                        <ul className="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <button onClick={() => { closeCollapse(); setConfirmLogoutOpen(true); }} className="dropdown-item text-danger"><i className="bi bi-box-arrow-right me-2"></i>Cerrar Sesión</button>
                                            </li>
                                        </ul>
                                    </li>
                                </>
                                ...
                                <>
                                    <li className="nav-item">
                                        ...
                                        <li className="nav-item">
                                                <Link to="/registro" onClick={handleNavClick} className={`btn ${styles['btn-register']}`}><i className="bi bi-person-plus me-1"></i>Registrarse</Link>
                                        </li>
                                </>
                            )}
            ...
            <Modal show={confirmLogoutOpen} title="Cerrar sesión" onClose={() => setConfirmLogoutOpen(false)} onConfirm={() => { closeCollapse(); logout(); navigate('/'); setConfirmLogoutOpen(false); }} confirmLabel="Sí, cerrar" cancelLabel="Cancelar">
